 ...
 * @author Andres Ochoa
 */
public class VentanaRectangulo extends javax.swing.JInternalFrame implements ActionListener {

    private PaintRectangulo panelPaint;
    ...
    public VentanaRectangulo() {
        ...
        this.panelPaint = new PaintRectangulo();
