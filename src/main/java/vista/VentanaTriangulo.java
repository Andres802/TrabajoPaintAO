 ...
 * @author Andres Ochoa
 */
public class VentanaTriangulo extends javax.swing.JInternalFrame implements ActionListener {

    private PaintTriangulo panelPaint;
    ...
    public VentanaTriangulo() {
        ...
        this.panelPaint = new PaintTriangulo();
