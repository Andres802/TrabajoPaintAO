 ...
 * @author Andres Ochoa
 */
public class VentanaCirculo extends javax.swing.JInternalFrame implements ActionListener {

    private PaintCirculo panelPaint;
    ...
    public VentanaCirculo() {
        ...
        this.panelPaint = new PaintCirculo();
