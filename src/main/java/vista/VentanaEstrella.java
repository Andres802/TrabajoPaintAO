 ...
 * @author Andres Ochoa
 */
public class VentanaEstrella extends javax.swing.JInternalFrame implements ActionListener {

    private PaintEstrella panelPaint;
    ...
    public VentanaEstrella() {
        ...
        this.setTitle("Estrella");
        
        this.panelPaint = new PaintEstrella();
